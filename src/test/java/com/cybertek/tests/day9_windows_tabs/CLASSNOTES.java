...
a href=httpswww.tesla.com Tesla WebPage a
div
...
driver.findElement(by.locator).isDisplayed(); -- truefalse
...
- Starting with double slash means you can lookstart from anywhere in the HTML code
...
button class=btn btn-primary onclick=button2() name=button2Button 2button
